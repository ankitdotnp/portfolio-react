      ...
      <div className="mx-auto px-2 w-full max-w-3xl">
        <div className="space-y-8">
          ...
          <div className="space-y-4 text-gray-800">
            ...
            <p className='text-base text-wrap'>
              Right now, I'm working on <span className="text-blue-800 font-bold underline"><a href="https://github.com/ankitkarki27/eLearning-Platform-django-react">Digital Padhai</a></span>, a Full Stack LMS platform where I'm handling both backend and frontend development.
            </p>
          </div>
