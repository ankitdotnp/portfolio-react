...
const About = () => {
 ...
 <p className="text-gray-600 text-base">Backend Developer</p>
          ...
          <div className="space-y-4 text-gray-700 pt-0">
            ...
            <p className='text-base text-wrap'>
              Currently working on <span className="text-black font-semibold"><a href="https://github.com/ankitkarki27/eLearning-Platform-django-react">Digital Padhai </a></span>, a LMS platform where I lead both backend and frontend development.
            </p>
          </div>
