...
import { Github, Linkedin, DownloadIcon, Mail, Phone, MapPin, Youtube, YoutubeIcon, Instagram, Send, SendIcon, LucideBatteryMedium, File } from 'lucide-react';
      ...
      <div className="mx-auto px-2 max-w-3xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="p-4 rounded">
            <h3 className="font-semibold text-black text-base mb-3">Send me a message
            ...
            >
              ...
              <div>
                <label htmlFor="project" className="block text-base font-medium text-gray-700 mb-1">Message</label>
                <textarea
                  id="project"
                  name="project"
                  rows="4"
              ...
              <button
                type="submit"
                className="px-4 py-2 bg-black hover:bg-gray-800 border-1 border-gray-300 rounded-lg text-white focus:outline-none focus:ring-1 focus:ring-gray-400 text-base font-medium transition-colors cursor-pointer"
              >
